...
class GeneratedObjectTest extends BookstoreTestBase
{
    ...
    */
    ...
    public function testReplace_RelationWithCompositePK()
    {
        ...
        $this->assertTrue(!is_null($op2->getBook()), 'BookOpinion2 has a relation to the Book');
        $this->assertInstanceOf(Book::class, $op2->getBook(), 'BookOpinion2 has a relation to the Book');
